...
def main():
    ...
    parser.add_argument("--pretrained_model_path", type=str, default="bart_large")
    ...
    parser.add_argument(
        "--eval_period", type=int, default=1000, help="Evaluate & save model"
    )
    parser.add_argument(
        "--train_loss_report_period",
        type=int,
        default=10,
        help="report the training loss",
    )
    parser.add_argument(
