'''
Author: your name
Date: 2021-10-19 05:56:24
LastEditTime: 2021-10-19 05:56:26
LastEditors: Please set LastEditors
Description: In User Settings Edit
FilePath: /zhaoheng_huang/SIGIR2022/seq2seq/loss/loss.py
'''
...
class NLLLoss(Loss):
    ...
    def __init__(self, weight=None, mask=None, size_average=True):
        ...
        reduction = 'mean'
        if not size_average: reduction = 'sum'
        ...
        super(NLLLoss, self).__init__(
            self._NAME,
            nn.NLLLoss(reduction=reduction, ignore_index=mask))
    ...
    def eval_batch(self, outputs, target):
        ...
        self.acc_loss += F.nll_loss(outputs, target, ignore_index=self.mask, reduction=self.reduction)
        self.norm_term += 1
